...
const options = {
    ...
    onClose (selectedDates) {
        ...
        if (selectedDate - new Date() <= 0) (0, _notiflixNotifyAio.Notify).failure("Please choose a date in the future", {
            timeout: 3000
        });
...
},{"flatpickr":"llQu5","notiflix/build/notiflix-notify-aio":"eXQLZ","flatpickr/dist/flatpickr.min.css":"eVN6V","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"llQu5":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
